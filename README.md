...
[![Version](https://img.shields.io/badge/version-1.0.0-blue)](https://clawhub.ai/skills/dobi-harness)
...
Dobi-harness 是一个完整的多 Agent 编排系统，为 OpenClaw Agent 提供：
...
- **GitHub Issues**: https://github.com/Panb-KG/dobi-harness/issues
- **ClawHub**: https://clawhub.ai/skills/dobi-harness
